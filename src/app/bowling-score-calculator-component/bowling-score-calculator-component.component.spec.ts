...
import { BowlingScoreCalculatorComponentComponent } from './bowling-score-calculator-component.component';

describe('BowlingScoreCalculatorComponentComponent', () => {
  let component: BowlingScoreCalculatorComponentComponent;
  let fixture: ComponentFixture<BowlingScoreCalculatorComponentComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ BowlingScoreCalculatorComponentComponent ],
      imports:[FormsModule],
      schemas: [ CUSTOM_ELEMENTS_SCHEMA ]
    })
    .compileComponents();

    fixture = TestBed.createComponent(BowlingScoreCalculatorComponentComponent);
  ...
  function addFrames(frames:number, firstRoll:number, secondRoll?:number, thirdRoll?:number){
    for(let i=0;i<frames;i++){
      component.formData.first = firstRoll;
      component.formData.second = secondRoll;
      component.formData.third = thirdRoll;
